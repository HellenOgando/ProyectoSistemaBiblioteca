 ...
 * @author albe211
 */
public class TablaPrestamoDemo extends javax.swing.JFrame {

    /**
     * Creates new form TablaPrestamoDemo
     */
    public TablaPrestamoDemo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaPrestamoDemo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaPrestamoDemo().setVisible(true);
            }
        });
    }
